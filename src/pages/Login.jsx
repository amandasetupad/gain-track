      ...
      >
        ...
        <div className="bg-slab-900 border border-slab-850 rounded-xl p-6 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="login-email" className="block text-sm font-medium text-zinc-400 mb-1">Email</label>
            ...
            <div>
              <label htmlFor="login-password" className="block text-sm font-medium text-zinc-400 mb-1">Password</label>
              <div className="relative">
